...
<body>
  ...
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="#" class="logo d-flex  scrollto me-auto me-lg-0">
        <!-- Uncomment the line below if you also wish to use an image logo -->
        <!-- <img src="assets/img/earnmoney.png" width="100" alt=""> -->
        <h1>Money MC LLC<span>.</span></h1>
      </a>

      <nav id="navbar" class="navbar">
        <ul>

          <li class="dropdown" ><a href="#" class="active"><span>Home</span></a>
          </li>
      ...
      <a class="btn-getstarted scrollto" href="account/">Join</a>
      ...
      <div class="container">
        <div class="row justify-content-center gy-6">
          ...
          <div class="col-lg-9 text-center">
            <h2>Welcome to Money MC LLC</h2>
            <p>At Money MC LLC, we assist and guide entrepreneurs of all industries into achieving financial growth. We are specialized in finding the ideal financial solutions for companies in the fields of bookkeeping, business credit consulting, tax planning and preparation, general financial planning, employee benefits and compensations, and much more </p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Bookkeeping</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Business Credit Consulting</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Tax Planning / Tax Solutions</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Employee's Benefit</a></h4>
    ...
    <div class="footer-legal text-center">
      <div class="container d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
        ...
        <div class="d-flex flex-column align-items-center align-items-lg-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Money MC LLC</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
