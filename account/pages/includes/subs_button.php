...
<li class="nav-item lh-1 me-3"><button class="btn btn-sm btn-dark nosubscriptions hidden" data-bs-toggle="modal" data-bs-target="#notSubs" data-backdrop="static" data-keyboard="false" > Subscribe Now </button> </li>
