                ...
                <?php
                  ...
                  <!-- <h5 class="card-header">Resource Categories</h5> -->
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#addcatmodal">
                          Add New
                        </button>
                    </div>
                              ...
                              foreach($stmt as $row){
                                ...
                                echo "
                                  <tr>
                                    ...
                                    <td>".$status."</td>
                                    <td>
                                      <button class='btn btn-outline-success btn-sm edit' data-id='".$row['id']."'><i class='fa fa-edit'></i> Edit Category</button>
                                      <button class='btn btn-outline-danger btn-sm delete ' data-id='".$row['id']."'><i class='fa fa-trash'></i> Delete</button>
                                    </td>
                                  </tr>
                                ";
                              }
