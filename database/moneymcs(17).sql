...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2022 at 06:44 PM
...
(1, 'Test', 'Name', 'test@gmail.com', '12345', 'Alabama', '1', 'Business Credit Builder', '0000-00-00');
...
(1, 'ITIN', 'January Courses', 'This course provides comprehensive tax preparer training on the specifics of dealing with non-citizen taxpayers and their tax identification numbers, or ITINs (Individual Taxpayer Identification Numbers).', '299.00', ' Includes: Online system training\r\n 3 hours (online classes)\r\n Certification Acceptance Agent\r\n Book:\r\n Language:', 'itintax.jpeg', 'image/jpeg', 1);
...
(15, 'mGa7XKgXX', '', 'sadmin@sadmin.com', '$2y$10$Rc6lsESCDG9Vf.Vf2.Nm/OXA92RoC9pM1FWLbnLwuvoEQZGvzSrWS', 0, 'Super User', 'System', 'U', '', '', 'defaultx.jpg', 1, '', '3Qg6AIKEkGSDyUP', '2022-10-27', '2022-11-29', '', '::1'),
