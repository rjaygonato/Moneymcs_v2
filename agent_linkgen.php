                                ...
                                <tbody class="table-border-bottom-0 col-12">
                                  <tr>
                                    ...
                                    <td class=" input-group">
                                      <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="buttonrefcode" value="https://joinmoneymcs.com/moneymcs/createref.php?referral=<?php echo $free_user['regcode']; ?>&link=<?php echo $free_user['id']; ?>" id="myrefCode">
