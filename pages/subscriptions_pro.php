                ...
                <div class="container-fluid  mt-100">
                  <div class="row">
                    <div class="col-md-5">
                      <div class="card">
                        <div class="card-body">
                            <h5 class="card-title text-primary">$599.00 - Monthly </h5>
                            <p class="card-text">
                            For affiliate agents with services ( Bookkeeping , Personal credit repair and Tax Services)
                            </p>
                            <!-- <a href="#" class="btn btn-sm btn-success">Pay now</a> -->
                            <button class="btn btn-sm btn-success nosubscriptions hidden" data-bs-toggle="modal" data-bs-target="#proSub" data-backdrop="static" data-keyboard="false" > Select </button> 
                        </div>
                      </div>
                    </div>
                  </div>
