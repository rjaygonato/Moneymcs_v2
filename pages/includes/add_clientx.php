              ...
              <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-md-10">
                    ...
                    <select class="form-control" name="state" id="clients" >
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-md-10">
                    ...
                    <select class="form-control" name="type" id="clientt" >
                        <option selected disabled>-Select-</option>
              ...
              <div class="col mb-0">
                <label for="firstname" class="form-label">First Name</label>
                  ...
                  <div class="col mb-0">
                    ...
                    <input type="text" name="lastname" id="lastname" class="form-control" placeholder="Enter Name" />
                  </div>
                  </div>
                  <div class="row g-2 mb-3">
                    <div class="col mb-0">
