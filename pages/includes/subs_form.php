      ...
      <div class="modal-body">
        ...
        <!-- <h6>
          ...
          <form id="myForm" action="subs" method="POST">
            <input type="hidden" id="sub_type" name="subs_name" value="Standard Membership - Monthly"/>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- <h6>
          ...
          <form id="myForm" action="subs" method="POST">
            <input type="hidden" id="suby_type" name="subs_name" value="Standard Membership - Yearly"/>
            <input type="hidden" name="usersid" id="user" value="<?php echo $agent['id']; ?>" />
            <input type="hidden" id="transactid" name="trans_id" />
            <input type="hidden" name="date" />
            <input type="hidden" name="totalp" id="totalp" />
        ...
        <!-- <center><img src="../assets/img/earnmoney.png" width="100" alt=""></center> -->
          ...
          <!-- <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
            <option value="99"></option>
              ...
              <option value="1,188">$ 1,188 Yearly Membership</option> 
          </select> --> Plus Membership
          <!-- $<input class="form-control" type="text"  name="" /> -->

          <div class="input-group input-group-merge">
            <span class="input-group-text">$</span>
            <input type="text" class="form-control" id="t_amountp" name="total" placeholder="" value="299.00" aria-label="Amount (to the nearest dollar)">
            <!-- <span class="input-group-text">.00</span> -->
          </div>
          ...
          <div id="smart-button-container">
            <div style="text-align: center;">
              <div id="paypal-button-containerplus"></div>
            </div>
          </div><hr>
          <!-- <h5> Become a referral agent today! </h5> -->
        <!-- <h6>
          ...
          <form id="myForm" action="subs" method="POST">
            <input type="hidden" id="subp_type" name="subs_name" value="Plus Membership - Monthly"/>
            <input type="hidden" name="usersid" id="user" value="<?php echo $agent['id']; ?>" />
            <input type="hidden" id="transactid" name="trans_id" />
            <input type="hidden" name="date" />
            <input type="hidden" name="totalp" id="totalp" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- <center><img src="../assets/img/earnmoney.png" width="100" alt=""></center> -->
          ...
          <div class="input-group input-group-merge">
            <span class="input-group-text">$</span>
            <input type="text" class="form-control" id="t_amountpr" name="total" placeholder="" value="599.00" aria-label="Amount (to the nearest dollar)">
            <!-- <span class="input-group-text">.00</span> -->
          </div>
          ...
          <div id="smart-button-container">
            <div style="text-align: center;">
              <div id="paypal-button-containerpro"></div>
            </div>
          </div><hr>
          <!-- <h5> Become a referral agent today! </h5> -->
        <!-- <h6>
          ...
          <form id="myForm" action="subs" method="POST">
            <input type="hidden" id="subpr_type" name="subs_name" value="Pro Membership - Monthly"/>
            <input type="hidden" name="usersid" id="user" value="<?php echo $agent['id']; ?>" />
            <input type="hidden" id="transactid" name="trans_id" />
            <input type="hidden" name="date" />
            <input type="hidden" name="totalp" id="totalp" />
